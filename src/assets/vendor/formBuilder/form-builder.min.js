...
! function (e) {
    ...
    ! function (e) {
        ...
        var O = function (e, t, r) {
                ...
                Y = function (t, n) {
                    ...
                    var s = e.disabledFieldButtons[i] || t.disabledFieldButtons,
                        u = [j("a", null, {
                            type: "size",
                            id: "size_" + b.lastID,
                            className: "del-size btn icon-25 size-confirm",
                            title: "Change Size"
                        }), j("a", null, {
                            type: "remove",
                            id: "del_" + b.lastID,
            ...
            })), C.on("click", ".icon-25", (function (e) {
                e.preventDefault();
                if ($(this).closest("li").hasClass("w-25")) {
                    $(this).closest("li").css("width", "33.33333%");
                    $(this).closest("li").addClass("w-33");
                    $(this).closest("li").removeClass("w-25");
                    $(this).closest("li").removeClass("w-75");
                    $(this).closest("li").removeClass("w-50");
                    $(this).closest("li").removeClass("w-100");
                }
                else if ($(this).closest("li").hasClass("w-33")) {
                    $(this).closest("li").css("width", "50%");
                    $(this).closest("li").addClass("w-50");
                    $(this).closest("li").removeClass("w-25");
                    $(this).closest("li").removeClass("w-75");
                    $(this).closest("li").removeClass("w-33");
                    $(this).closest("li").removeClass("w-100");
                }
                else if ($(this).closest("li").hasClass("w-50")) {
                    $(this).closest("li").css("width", "75%");
                    $(this).closest("li").addClass("w-75");
                    $(this).closest("li").removeClass("w-25");
                    $(this).closest("li").removeClass("w-50");
                    $(this).closest("li").removeClass("w-33");
                    $(this).closest("li").removeClass("w-100");
                }
                else if ($(this).closest("li").hasClass("w-75")) {
                    $(this).closest("li").css("width", "100%");
                    $(this).closest("li").addClass("w-100");
                    $(this).closest("li").removeClass("w-25");
                    $(this).closest("li").removeClass("w-50");
                    $(this).closest("li").removeClass("w-33");
                    $(this).closest("li").removeClass("w-75");
                }
                else if ($(this).closest("li").hasClass("w-100")) {
                    $(this).closest("li").css("width", "25%");
                    $(this).closest("li").addClass("w-25");
                    $(this).closest("li").removeClass("w-100");
                    $(this).closest("li").removeClass("w-50");
                    $(this).closest("li").removeClass("w-33");
                    $(this).closest("li").removeClass("w-75");
